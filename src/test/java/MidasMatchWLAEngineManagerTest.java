...
public class MidasMatchWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(MidasMatchWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/MidasMatchWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/MidasMatchWLAIW/InitOutcome.xml").getDocumentElement();
